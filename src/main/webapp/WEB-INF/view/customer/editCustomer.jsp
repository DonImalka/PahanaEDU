...
<body>
	<div class="container">
		...
		<c:if test="${not empty customer}">
			<div class="form-container">
				<div class="customer-info">
					<strong>Editing Customer: ${customer.name}</strong><br> <small>Account
						Number: ${customer.accountNumber}</small>
				</div>
				...
				<form action="customer" method="post">
					...
					<div class="form-group">
						<label for="name">Customer Name</label> <input type="text"
							id="name" name="name" required placeholder="Enter customer name"
							value="${customer.name}">
					</div>
		...
		<div class="nav-links">
			<a href="customer">Back to Customer List</a> <a href="dashboard">Dashboard</a>
			<a href="product">Product Management</a> <a href="bill">Billing
				Management</a> <a href="dashboard?action=help">Help</a> <a
				href="auth?action=logout">Logout</a>
		</div>
	</div>
</body>
</html>
